...
mycursor.execute("CREATE TABLE IF NOT EXISTS playerdatabase.players (player_id INT(2) PRIMARY KEY, player_name VARCHAR(255), score INTEGER (4))")
...
top.configure(background="#227dd3")
...
play_button.configure(background="#0dc99d", fg="#c90d3f", disabledforeground="grey")
...
difficulty_Button.configure(background="#0dc99d", fg="#c90d3f", disabledforeground="grey")
...
guess_box.configure(background="white")
...
guess_label.configure(background="#6d54c0", fg="#3eea44")
...
result_button.configure(background="#0dc99d", disabledforeground="grey", fg="#c90d3f")
